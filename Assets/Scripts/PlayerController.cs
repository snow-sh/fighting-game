...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] Rigidbody rigidbody3D;
    [SerializeField] ConfigurableJoint mainJoint;
    [SerializeField] Transform cameraTransform; // Drag your Main Camera here!
    ...
    void Awake()
    {
        ...
        // Start with current rotation to prevent snapping
    ...
    void FixedUpdate()
    {
        ...
        // 2. Handle Movement and Rotation
        if (moveDir.magnitude > 0.1f)
        {
            // Apply Drunk Wobble to the direction
            wobbleTimer += Time.fixedDeltaTime * wobbleFrequency;
        ...
        // 3. Update the Joint to match target rotation
        // ConfigurableJoints require the inverse rotation in most setups
